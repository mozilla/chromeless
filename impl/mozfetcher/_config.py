software = {
    "Linux_64bit": {
       "url": "ftp://ftp.mozilla.org/pub/mozilla.org/xulrunner/releases/6.0.2/runtimes/xulrunner-6.0.2.en-US.linux-x86_64.tar.bz2",
    ...
    ( "Darwin_64bit", "Darwin_32bit" ): {
        "url": "ftp://ftp.mozilla.org/pub/mozilla.org/xulrunner/releases/6.0.2/sdk/xulrunner-6.0.2.en-US.mac-i386.sdk.tar.bz2",
    ...
    ( "Windows_32bit", "Windows_64bit" ): {
        "url": "ftp://ftp.mozilla.org/pub/mozilla.org/xulrunner/releases/6.0.2/runtimes/xulrunner-6.0.2.en-US.win32.zip",
    ...
    "Linux_32bit": {
        "url": "ftp://ftp.mozilla.org/pub/mozilla.org/xulrunner/releases/6.0.2/runtimes/xulrunner-6.0.2.en-US.linux-i686.tar.bz2",
